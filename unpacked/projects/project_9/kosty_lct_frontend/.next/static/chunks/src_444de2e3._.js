...
function ChartCard(param) {
    let { title, data, series, yLabel, height = 300 } = param;
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "space-y-2",
        children: [
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$monitoring$2f$ui$2f$chart$2d$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ChartCard"], {
                title: "Heart Rate (BPM) - ".concat(bpmWindow.dataCount, " точек (").concat(WINDOW_SIZE, "с окно)"),
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$monitoring$2f$ui$2f$chart$2d$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ChartCard"], {
                title: "Uterine Contractions (UC) - ".concat(ucWindow.dataCount, " точек (").concat(WINDOW_SIZE, "с окно)"),
...
_s(RealtimeCharts, "0mXK+ksi56w2JXIH65ZJfuMe28c=", false, function() {
    return [
...
function useAIAlerts() {
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "useAIAlerts.useMemo": ()=>{
            ...
            if (status === 'Тревога') {
                alerts.push({
                    id: "status-alert-".concat(lastMessage.time),
                    type: 'error',
                ...
                alerts.push({
                    id: "status-warning-".concat(lastMessage.time),
                    type: 'warning',
            ...
            lastMessage.short_term.events.forEach({
                "useAIAlerts.useMemo": (event, index)=>{
                    if (event.severity > 0.7) {
                        alerts.push({
                            id: "event-high-".concat(lastMessage.time, "-").concat(index),
                            type: 'error',
                            title: 'Высокая критичность события',
                            message: "".concat(event.type, ": severity ").concat(event.severity.toFixed(2)),
                            timestamp: new Date(lastMessage.time * 1000),
                            acknowledged: false,
                        ...
                        alerts.push({
                            id: "event-medium-".concat(lastMessage.time, "-").concat(index),
                            type: 'warning',
            ...
            if (lastMessage.long_term.hypoxia_60 > 0.8) {
                alerts.push({
                    id: "hypoxia-high-".concat(lastMessage.time),
                    type: 'error',
                    title: 'Высокий риск гипоксии',
                    message: "Вероятность гипоксии 60: ".concat((lastMessage.long_term.hypoxia_60 * 100).toFixed(1), "%"),
                    timestamp: new Date(lastMessage.time * 1000),
                    acknowledged: false
                });
            } else if (lastMessage.long_term.hypoxia_60 > 0.6) {
                alerts.push({
                    id: "hypoxia-medium-".concat(lastMessage.time),
                    type: 'warning',
            ...
            if (lastMessage.long_term.emergency_30 > 0.7) {
                alerts.push({
                    id: "emergency-high-".concat(lastMessage.time),
                    type: 'error',
                    title: 'Высокий риск экстренной ситуации',
                    message: "Вероятность экстренной ситуации 30: ".concat((lastMessage.long_term.emergency_30 * 100).toFixed(1), "%"),
                    timestamp: new Date(lastMessage.time * 1000),
                    acknowledged: false
                });
            } else if (lastMessage.long_term.emergency_30 > 0.5) {
                alerts.push({
                    id: "emergency-medium-".concat(lastMessage.time),
                    type: 'warning',
            ...
            const sortedAlerts = alerts.sort({
                "useAIAlerts.useMemo.sortedAlerts": (a, b)=>b.timestamp.getTime() - a.timestamp.getTime()
            }["useAIAlerts.useMemo.sortedAlerts"]);
...
_s(useAIAlerts, "Z7zeZhuDHYCO48a+KL8tM3HI1y0=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$store$2f$websocket$2d$selectors$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useLastAIMessage"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$store$2f$websocket$2d$selectors$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAIStatus"]
    ];
...
function AlertsPanel() {
    ...
    const [acknowledgedIds, setAcknowledgedIds] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(new Set());
                            ...
                            acknowledgedAlerts.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            acknowledgedAlerts.slice(0, 10).map((alert)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            acknowledgedAlerts.length > 10 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(AlertsPanel, "rSM3XmEwNFO4ILgbIZnyP3iut64=", false, function() {
    return [
...
//# sourceMappingURL=src_444de2e3._.js.map