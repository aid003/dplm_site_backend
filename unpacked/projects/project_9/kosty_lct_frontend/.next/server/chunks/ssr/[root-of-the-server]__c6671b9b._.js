...
"[project]/src/shared/store/websocket-selectors.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const useAIData = ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$store$2f$websocket$2d$store$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["useWebSocketStore"])((state)=>state.aiData);
const useLastAIMessage = ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$store$2f$websocket$2d$store$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["useWebSocketStore"])((state)=>state.lastAIMessage);
const useAIStatus = ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$store$2f$websocket$2d$store$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["useWebSocketStore"])((state)=>state.aiStatus);
const useBPMData = ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$store$2f$websocket$2d$store$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["useWebSocketStore"])((state)=>state.bpmData);
const useLastBPMMessage = ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$store$2f$websocket$2d$store$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["useWebSocketStore"])((state)=>state.lastBPMMessage);
const useBPMStatus = ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$store$2f$websocket$2d$store$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["useWebSocketStore"])((state)=>state.bpmStatus);
const useUCData = ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$store$2f$websocket$2d$store$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["useWebSocketStore"])((state)=>state.ucData);
const useLastUCMessage = ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$store$2f$websocket$2d$store$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["useWebSocketStore"])((state)=>state.lastUCMessage);
const useUCStatus = ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$store$2f$websocket$2d$store$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["useWebSocketStore"])((state)=>state.ucStatus);
const useRecentAIData = (count)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$store$2f$websocket$2d$store$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["useWebSocketStore"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$react$2f$shallow$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["useShallow"])((state)=>state.aiData.slice(-count)));
const useRecentBPMData = (count)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$store$2f$websocket$2d$store$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["useWebSocketStore"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$react$2f$shallow$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["useShallow"])((state)=>state.bpmData.slice(-count)));
const useRecentUCData = (count)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$store$2f$websocket$2d$store$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["useWebSocketStore"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$react$2f$shallow$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["useShallow"])((state)=>state.ucData.slice(-count)));
const useAllSocketsConnected = ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$store$2f$websocket$2d$store$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["useWebSocketStore"])((state)=>state.aiStatus === 'connected' && state.bpmStatus === 'connected' && state.ucStatus === 'connected');
const useConnectionStatus = ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$store$2f$websocket$2d$store$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["useWebSocketStore"])((state)=>({
            ai: state.aiStatus,
            bpm: state.bpmStatus,
            uc: state.ucStatus
        }));
const useWebSocketActions = ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$store$2f$websocket$2d$store$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["useWebSocketStore"])((state)=>({
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$store$2f$websocket$2d$store$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/shared/store/websocket-store.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$store$2f$websocket$2d$selectors$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/shared/store/websocket-selectors.ts [app-rsc] (ecmascript)");
;
;
...
"[project]/src/shared/hooks/use-websocket.ts [app-rsc] (client reference proxy) <module evaluation>", ((__turbopack_context__) => {
"use strict";
...
;
const useAIWebSocket = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$server$2d$dom$2d$turbopack$2d$server$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerClientReference"])(function() {
    throw new Error("Attempted to call useAIWebSocket() from the server but useAIWebSocket is on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.");
}, "[project]/src/shared/hooks/use-websocket.ts <module evaluation>", "useAIWebSocket");
const useAllWebSockets = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$server$2d$dom$2d$turbopack$2d$server$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerClientReference"])(function() {
    throw new Error("Attempted to call useAllWebSockets() from the server but useAllWebSockets is on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.");
}, "[project]/src/shared/hooks/use-websocket.ts <module evaluation>", "useAllWebSockets");
const useBPMWebSocket = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$server$2d$dom$2d$turbopack$2d$server$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerClientReference"])(function() {
    throw new Error("Attempted to call useBPMWebSocket() from the server but useBPMWebSocket is on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.");
}, "[project]/src/shared/hooks/use-websocket.ts <module evaluation>", "useBPMWebSocket");
const useUCWebSocket = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$server$2d$dom$2d$turbopack$2d$server$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerClientReference"])(function() {
    throw new Error("Attempted to call useUCWebSocket() from the server but useUCWebSocket is on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.");
}, "[project]/src/shared/hooks/use-websocket.ts <module evaluation>", "useUCWebSocket");
}),
"[project]/src/shared/hooks/use-websocket.ts [app-rsc] (client reference proxy)", ((__turbopack_context__) => {
"use strict";
...
const useAIWebSocket = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$server$2d$dom$2d$turbopack$2d$server$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerClientReference"])(function() {
    throw new Error("Attempted to call useAIWebSocket() from the server but useAIWebSocket is on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.");
}, "[project]/src/shared/hooks/use-websocket.ts", "useAIWebSocket");
const useAllWebSockets = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$server$2d$dom$2d$turbopack$2d$server$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerClientReference"])(function() {
    throw new Error("Attempted to call useAllWebSockets() from the server but useAllWebSockets is on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.");
}, "[project]/src/shared/hooks/use-websocket.ts", "useAllWebSockets");
const useBPMWebSocket = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$server$2d$dom$2d$turbopack$2d$server$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerClientReference"])(function() {
    throw new Error("Attempted to call useBPMWebSocket() from the server but useBPMWebSocket is on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.");
}, "[project]/src/shared/hooks/use-websocket.ts", "useBPMWebSocket");
const useUCWebSocket = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$server$2d$dom$2d$turbopack$2d$server$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerClientReference"])(function() {
    throw new Error("Attempted to call useUCWebSocket() from the server but useUCWebSocket is on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.");
}, "[project]/src/shared/hooks/use-websocket.ts", "useUCWebSocket");
}),
"[project]/src/shared/hooks/use-websocket.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";

var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$hooks$2f$use$2d$websocket$2e$ts__$5b$app$2d$rsc$5d$__$28$client__reference__proxy$29$__$3c$module__evaluation$3e$__ = __turbopack_context__.i("[project]/src/shared/hooks/use-websocket.ts [app-rsc] (client reference proxy) <module evaluation>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$hooks$2f$use$2d$websocket$2e$ts__$5b$app$2d$rsc$5d$__$28$client__reference__proxy$29$__ = __turbopack_context__.i("[project]/src/shared/hooks/use-websocket.ts [app-rsc] (client reference proxy)");
;
__turbopack_context__.n(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$hooks$2f$use$2d$websocket$2e$ts__$5b$app$2d$rsc$5d$__$28$client__reference__proxy$29$__);
}),
"[project]/src/shared/hooks/use-sliding-window.ts [app-rsc] (client reference proxy) <module evaluation>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$server$2d$dom$2d$turbopack$2d$server$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/server/route-modules/app-page/vendored/rsc/react-server-dom-turbopack-server.js [app-rsc] (ecmascript)");
;
const useSlidingWindow = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$server$2d$dom$2d$turbopack$2d$server$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerClientReference"])(function() {
    throw new Error("Attempted to call useSlidingWindow() from the server but useSlidingWindow is on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.");
}, "[project]/src/shared/hooks/use-sliding-window.ts <module evaluation>", "useSlidingWindow");
}),
"[project]/src/shared/hooks/use-sliding-window.ts [app-rsc] (client reference proxy)", ((__turbopack_context__) => {
"use strict";
...
const useSlidingWindow = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$server$2d$dom$2d$turbopack$2d$server$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerClientReference"])(function() {
    throw new Error("Attempted to call useSlidingWindow() from the server but useSlidingWindow is on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.");
}, "[project]/src/shared/hooks/use-sliding-window.ts", "useSlidingWindow");
}),
"[project]/src/shared/hooks/use-sliding-window.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";

var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$hooks$2f$use$2d$sliding$2d$window$2e$ts__$5b$app$2d$rsc$5d$__$28$client__reference__proxy$29$__$3c$module__evaluation$3e$__ = __turbopack_context__.i("[project]/src/shared/hooks/use-sliding-window.ts [app-rsc] (client reference proxy) <module evaluation>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$hooks$2f$use$2d$sliding$2d$window$2e$ts__$5b$app$2d$rsc$5d$__$28$client__reference__proxy$29$__ = __turbopack_context__.i("[project]/src/shared/hooks/use-sliding-window.ts [app-rsc] (client reference proxy)");
;
__turbopack_context__.n(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$hooks$2f$use$2d$sliding$2d$window$2e$ts__$5b$app$2d$rsc$5d$__$28$client__reference__proxy$29$__);
}),
"[project]/src/shared/hooks/index.ts [app-rsc] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";

/**
 * Общие hooks приложения
 */ __turbopack_context__.s([]);
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$hooks$2f$use$2d$websocket$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/shared/hooks/use-websocket.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$hooks$2f$use$2d$sliding$2d$window$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/shared/hooks/use-sliding-window.ts [app-rsc] (ecmascript)");
;
;
}),
...
"[project]/src/shared/api/websocket.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/shared/api/index.ts [app-rsc] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";

/**
 * API слой приложения
 */ __turbopack_context__.s([]);
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$api$2f$websocket$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/shared/api/websocket.ts [app-rsc] (ecmascript)");
;
}),
"[project]/src/shared/config/app-config.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$hooks$2f$index$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/src/shared/hooks/index.ts [app-rsc] (ecmascript) <locals>");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$api$2f$index$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/src/shared/api/index.ts [app-rsc] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$config$2f$app$2d$config$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/shared/config/app-config.ts [app-rsc] (ecmascript)");
;
;
;
;
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c6671b9b._.js.map