...
"[project]/src/shared/store/websocket-store.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/shared/api/websocket.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function createMockAISocketImpl(onMessage, onStatusChange) {
    ...
    return {
        connect () {
            onStatusChange === null || onStatusChange === void 0 ? void 0 : onStatusChange('open');
            start();
        },
        disconnect () {
            if (timer) {
            ...
            onStatusChange === null || onStatusChange === void 0 ? void 0 : onStatusChange('close');
        },
        getReadyState () {
            return 1;
        },
...
class WebSocketClient {
   ...
   */ connect() {
        ...
        this.ws.onopen = ()=>{
            var _this_onStatusChange, _this;
            console.log("[WebSocket] Connected to ".concat(this.url));
            this.reconnectAttempts = 0;
            (_this_onStatusChange = (_this = this).onStatusChange) === null || _this_onStatusChange === void 0 ? void 0 : _this_onStatusChange.call(_this, 'open');
        };
        ...
        this.ws.onerror = (error)=>{
            var _this_onError, _this, _this_onStatusChange, _this1;
            console.error("[WebSocket] Error on ".concat(this.url, ":"), error);
            (_this_onError = (_this = this).onError) === null || _this_onError === void 0 ? void 0 : _this_onError.call(_this, error);
            (_this_onStatusChange = (_this1 = this).onStatusChange) === null || _this_onStatusChange === void 0 ? void 0 : _this_onStatusChange.call(_this1, 'error');
        };
        this.ws.onclose = ()=>{
            var _this_onStatusChange, _this;
            console.log("[WebSocket] Disconnected from ".concat(this.url));
            (_this_onStatusChange = (_this = this).onStatusChange) === null || _this_onStatusChange === void 0 ? void 0 : _this_onStatusChange.call(_this, 'close');
   ...
   */ attemptReconnect() {
        if (this.reconnectAttempts >= this.maxReconnectAttempts) {
            console.error("[WebSocket] Max reconnect attempts (".concat(this.maxReconnectAttempts, ") reached for ").concat(this.url));
            return;
        }
        this.reconnectAttempts++;
        console.log("[WebSocket] Reconnecting to ".concat(this.url, " (attempt ").concat(this.reconnectAttempts, "/").concat(this.maxReconnectAttempts, ")..."));
   ...
   */ isConnected() {
    ...
    constructor(config){
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "onMessage", void 0);
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "onStatusChange", void 0);
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "reconnectTimeout", null);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "isIntentionallyClosed", false);
        this.url = config.url;
        this.onMessage = config.onMessage;
        this.onError = config.onError;
        this.onStatusChange = config.onStatusChange;
        var _config_reconnectInterval;
        this.reconnectInterval = (_config_reconnectInterval = config.reconnectInterval) !== null && _config_reconnectInterval !== void 0 ? _config_reconnectInterval : 3000;
        var _config_maxReconnectAttempts;
        this.maxReconnectAttempts = (_config_maxReconnectAttempts = config.maxReconnectAttempts) !== null && _config_maxReconnectAttempts !== void 0 ? _config_maxReconnectAttempts : 5;
    }
}
...
"[project]/src/shared/config/app-config.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/shared/hooks/use-websocket.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
function useAIWebSocket() {
    let autoConnect = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : true;
    _s();
    const socketRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    const { addAIMessage, setAIStatus, aiStatus } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$store$2f$websocket$2d$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useWebSocketStore"])();
    const handleMessage = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useAIWebSocket.useCallback[handleMessage]": (message)=>{
            addAIMessage(message);
        }
    }["useAIWebSocket.useCallback[handleMessage]"], [
        addAIMessage
    ]);
    const handleStatusChange = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useAIWebSocket.useCallback[handleStatusChange]": (status)=>{
            const socketStatus = status === "open" ? "connected" : status === "error" ? "error" : "disconnected";
            setAIStatus(socketStatus);
        }
    }["useAIWebSocket.useCallback[handleStatusChange]"], [
        setAIStatus
    ]);
    const connect = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useAIWebSocket.useCallback[connect]": ()=>{
            if (!socketRef.current) {
                socketRef.current = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$api$2f$websocket$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createAISocket"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$config$2f$app$2d$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["appConfig"].websocket.ai, handleMessage, undefined, handleStatusChange);
            }
    ...
    const disconnect = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useAIWebSocket.useCallback[disconnect]": ()=>{
...
_s(useAIWebSocket, "e2cIcevIU+xloIxd2pDid4wbkos=", false, function() {
    return [
...
function useBPMWebSocket() {
    let autoConnect = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : true;
    _s1();
    const socketRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    const { addBPMMessage, setBPMStatus, bpmStatus } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$store$2f$websocket$2d$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useWebSocketStore"])();
    const handleMessage = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useBPMWebSocket.useCallback[handleMessage]": (message)=>{
            addBPMMessage(message);
        }
    }["useBPMWebSocket.useCallback[handleMessage]"], [
        addBPMMessage
    ]);
    const handleStatusChange = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useBPMWebSocket.useCallback[handleStatusChange]": (status)=>{
            const socketStatus = status === "open" ? "connected" : status === "error" ? "error" : "disconnected";
            setBPMStatus(socketStatus);
        }
    }["useBPMWebSocket.useCallback[handleStatusChange]"], [
        setBPMStatus
    ]);
    const connect = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useBPMWebSocket.useCallback[connect]": ()=>{
            if (!socketRef.current) {
                socketRef.current = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$api$2f$websocket$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createBPMSocket"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$config$2f$app$2d$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["appConfig"].websocket.bpm, handleMessage, undefined, handleStatusChange);
            }
            socketRef.current.connect();
        }
    }["useBPMWebSocket.useCallback[connect]"], [
    ...
    const disconnect = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useBPMWebSocket.useCallback[disconnect]": ()=>{
            var _socketRef_current;
            (_socketRef_current = socketRef.current) === null || _socketRef_current === void 0 ? void 0 : _socketRef_current.disconnect();
        }
    }["useBPMWebSocket.useCallback[disconnect]"], []);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useBPMWebSocket.useEffect": ()=>{
            if (autoConnect) {
                connect();
            }
            return ({
...
_s1(useBPMWebSocket, "rnCf3O2uBjaiHMRL0mG2noW2UxA=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$store$2f$websocket$2d$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useWebSocketStore"]
    ];
});
function useUCWebSocket() {
    let autoConnect = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : true;
    _s2();
    const socketRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    const { addUCMessage, setUCStatus, ucStatus } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$store$2f$websocket$2d$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useWebSocketStore"])();
    const handleMessage = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useUCWebSocket.useCallback[handleMessage]": (message)=>{
            addUCMessage(message);
        }
    }["useUCWebSocket.useCallback[handleMessage]"], [
        addUCMessage
    ]);
    const handleStatusChange = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useUCWebSocket.useCallback[handleStatusChange]": (status)=>{
            const socketStatus = status === "open" ? "connected" : status === "error" ? "error" : "disconnected";
            setUCStatus(socketStatus);
        }
    }["useUCWebSocket.useCallback[handleStatusChange]"], [
        setUCStatus
    ]);
    const connect = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useUCWebSocket.useCallback[connect]": ()=>{
            if (!socketRef.current) {
                socketRef.current = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$api$2f$websocket$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createUCSocket"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$config$2f$app$2d$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["appConfig"].websocket.uc, handleMessage, undefined, handleStatusChange);
            }
            socketRef.current.connect();
        }
    }["useUCWebSocket.useCallback[connect]"], [
    ...
    const disconnect = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useUCWebSocket.useCallback[disconnect]": ()=>{
            var _socketRef_current;
            (_socketRef_current = socketRef.current) === null || _socketRef_current === void 0 ? void 0 : _socketRef_current.disconnect();
        }
    }["useUCWebSocket.useCallback[disconnect]"], []);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useUCWebSocket.useEffect": ()=>{
            if (autoConnect) {
                connect();
            }
            return ({
...
_s2(useUCWebSocket, "LR5QgAsPCTPY+YPdgTKfovG+JM8=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$store$2f$websocket$2d$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useWebSocketStore"]
    ];
});
function useAllWebSockets() {
    let autoConnect = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : true;
    _s3();
    const ai = useAIWebSocket(autoConnect);
    const bpm = useBPMWebSocket(autoConnect);
    const uc = useUCWebSocket(autoConnect);
    const connectAll = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useAllWebSockets.useCallback[connectAll]": ()=>{
            ai.connect();
            bpm.connect();
            uc.connect();
        }
    ...
    const disconnectAll = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useAllWebSockets.useCallback[disconnectAll]": ()=>{
            ai.disconnect();
            bpm.disconnect();
            uc.disconnect();
        }
...
_s3(useAllWebSockets, "jVT8olS465gw0ynPWOz3AWTfiYI=", false, function() {
    return [
        useAIWebSocket,
        useBPMWebSocket,
        useUCWebSocket
...
"[project]/src/shared/hooks/use-sliding-window.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function useSlidingWindow(data, options) {
    ...
    const windowData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "useSlidingWindow.useMemo[windowData]": ()=>{
            if (data.length === 0) return [];
            const now = Date.now() / 1000;
            const windowStart = now - windowSize;
            // Фильтруем данные по времени
            const filteredData = data.filter({
                "useSlidingWindow.useMemo[windowData].filteredData": (point)=>point.time_sec >= windowStart
            }["useSlidingWindow.useMemo[windowData].filteredData"]);
    ...
    const updateTime = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useSlidingWindow.useCallback[updateTime]": ()=>{
    ...
    const chartData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "useSlidingWindow.useMemo[chartData]": ()=>{
            if (windowData.length === 0) return [
                [],
                []
            ];
            const t0 = windowData[0].time_sec;
            const x = windowData.map({
                "useSlidingWindow.useMemo[chartData].x": (p)=>p.time_sec - t0
            }["useSlidingWindow.useMemo[chartData].x"]);
            const y = windowData.map({
                "useSlidingWindow.useMemo[chartData].y": (p)=>p.value
            }["useSlidingWindow.useMemo[chartData].y"]);
            return [
                x,
                y
            ];
...
_s(useSlidingWindow, "GAlVzjnyfMupmwH5SkAYNGLAqOQ=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/src/shared/providers/store-provider.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/shared/providers/theme-provider.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
//# sourceMappingURL=_3fed7b9c._.js.map